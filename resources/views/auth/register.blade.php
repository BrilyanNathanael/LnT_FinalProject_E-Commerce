        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="daftar">
                <div class="daftar-content">
                    ...
                    <p>Sudah punya akun Mesunda? <a href="/login">Masuk</a></p>               
                </div>
                <div class="kotak"></div>
            </div>
            <div class="forms">
                <div class="forms-left">
                    ...
                    <label for="name" class="name">{{ __('Nama') }}</label>
                    ...
                    <div class="form-group">
                        <label for="no_hp" class="handphone">{{ __('No. HP') }}</label>
                ...
                <div class="forms-right">
                    <div class="forms-password">
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="confirm">{{ __('Konfirmasi Password') }}</label>
